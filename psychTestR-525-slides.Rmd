...
* I originally created this task in Qualtrics, but faced some problems with that format:
    ...
    + Because of this, participants had to manually click on each clip to play it
    + I had to brute force randomization of the stimuli with JavaScript code elements (messy)
    + Because of all of the above, I had to add more JavaScript to create and pull information about the stimuli that weren't automatically saved in the Qualtrics metadata
